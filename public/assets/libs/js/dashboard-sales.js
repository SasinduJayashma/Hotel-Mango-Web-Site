...
$(function() {
    ...
    var docRef = db.collection("/supermarkets_repo/ KLS/branch/KLS_KLEN_01/dashboardDetails").doc("dash_1");
    var ctx = document.getElementById('revenue').getContext('2d');

    docRef.get().then(function(doc) {
        if (doc.exists) {
            console.log("Document data:", doc.data().currentWeek);
            console.log("Document data:", doc.data().previousWeek);
